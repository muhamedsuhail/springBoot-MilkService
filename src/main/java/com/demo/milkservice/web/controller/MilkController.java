...
public class MilkController {
    ...
    @PostMapping
    public ResponseEntity saveNewMilk(@RequestBody @Valid MilkDTO milkDTO) {
        // TODO impl
    ...
    public void updateMilkById(@PathVariable("milkId") UUID milkId, @RequestBody @Valid MilkDTO milkDTO) {
